https://apps.sarvam.ai/api/app-authoring/orgs/sarvamai/workspaces/default/apps/Restaurant--2346c23a-3842?app_version=5&version_filter=specific&with_deployment_status=true&legacy=false

{
  ...
  "privacy_config": {
    "header": {
      "version": "1.0",
      "timestamp": "2026-01-05 07:01:21 +5:30"
    },
  ...
  "generated_suggestions": {
    "global_instructions": [
      "Language-steering instruction detected ('Respond in user's language (Tamil, Hindi, Telugu, Kannada, Malayalam, English)')"
    ]
  },
  "revision_count": 0
}